Public Class Edit_Orders
    ...
    Private Sub Edit_Orders_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        MINI_PASTRY_ORDERSTableAdapter.FillBy2(Bakery_OrdersDataSet.MINI_PASTRY_ORDERS)
        Holiday_NumberTextBox.Text = Form1.OrderID
        Mini_Pastry_Total_Price = Mini_Pastry_Total_PriceTextBox.Text
        Cookie_Total_Price = Cookie_TotalTextBox.Text
        Mini_Bar_Total_Price = Mini_Bar_Total_PriceTextBox.Text




    End Sub
    Public Mini_Pastry_Total_Price As Decimal
    Public Cookie_Total_Price As Decimal
    Public Mini_Bar_Total_Price As Decimal
    Public Item_Price_1 As Decimal
    Public Item_Price_2 As Decimal
    Public Item_Price_3 As Decimal
    Public Item_Price_4 As Decimal
    Public Item_Price_5 As Decimal
    Public Grand_Total As Decimal
    Public Order_Deposit As Decimal
    Public Order_Balance As Decimal
